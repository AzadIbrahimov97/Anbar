    ...
    <div class="card">
      <header class="card-header">
        <p class="card-header-title">
          <span class="icon"><i class="mdi mdi-clipboard-arrow-right"></i></span>
          {{ __('messages.daxilol') }}
        </p>
      </header>
        ...
        @csrf
          <div class="field spaced">
            ...
            <div class="control icons-left">
              <input class="input" type="text" name="email" required="" placeholder="user@example.com" autocomplete="username">
              <span class="icon is-small left"><i class="mdi mdi-email"></i></span>
            </div>
            <p class="help">
            {{ __('messages.emailreq') }}
            </p>
          </div>
          ...
          <div class="field spaced">
            ...
            <p class="control icons-left">
              <input class="input" type="password" name="password" required="" placeholder="" autocomplete="current-password">
              <span class="icon is-small left"><i class="mdi mdi-asterisk"></i></span>
            </p>
            <p class="help">
            {{ __('messages.paroldaxilet') }}
            </p>
          </div>
          ...
          <div class="field grouped">
            ...
            <div class="field grouped">
            <div class="control">
              <a href="{{route('users')}}" button type="button" class="button green">
